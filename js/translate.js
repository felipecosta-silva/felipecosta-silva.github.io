...
function languageEn() {
  //Navbar
  document.getElementById("perfil").innerHTML = "Start";
  ...
  document.getElementById("btndownloadfooter").value = "download curriculum";
  document.getElementById("phrase-footer").value = "Never let them tell you that it is not worth believing in the dream you have ...";
}
